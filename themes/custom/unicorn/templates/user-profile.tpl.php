    ...
    <div class="row">
      <div id="skill_legend">
        ...
        <div class="progress" id="legend">
          <div id="guidebar" class="progress-bar" style="width: 10%" popover="Little to no knowledge" popover-trigger="mouseenter"><div class="glyphicon glyphicon-trash"></div></div>
          <div id="guidebar" class="progress-bar" style="width: 10%" popover="Beginner Skill Level" popover-trigger="mouseenter"><div class="glyphicon glyphicon-thumbs-down"></div></div>
          <div id="guidebar" class="progress-bar" style="width: 10%" popover="Limited Knowledge" popover-trigger="mouseenter"><div class="glyphicon glyphicon-bullhorn"></div></div>
          <div id="guidebar" class="progress-bar" style="width: 10%" popover="Competent User" popover-trigger="mouseenter"><div class="glyphicon glyphicon-paperclip"></div></div>
          <div id="guidebar" class="progress-bar" style="width: 10%" popover="Team Contributor" popover-trigger="mouseenter"><div class="glyphicon glyphicon-bell"></div></div>
          <div id="guidebar" class="progress-bar" style="width: 10%" popover="Team Leader" popover-trigger="mouseenter"><div class="glyphicon glyphicon-pushpin"></div></div>
          <div id="guidebar" class="progress-bar" style="width: 10%" popover="Myplanet Contributor" popover-trigger="mouseenter"><div class="glyphicon glyphicon-tree-conifer"></div></div>
          <div id="guidebar" class="progress-bar" style="width: 10%" popover="Myplanet Leader" popover-trigger="mouseenter"><div class="glyphicon glyphicon-tower"></div></div>
          <div id="guidebar" class="progress-bar" style="width: 10%" popover="Industry Contributor" popover-trigger="mouseenter"><div class="glyphicon glyphicon-star"></div></div>
          <div id="guidebar" class="progress-bar" style="width: 10%" popover="Industry Leader (El Jefe!)" popover-trigger="mouseenter"><div class="glyphicon glyphicon-fire"></div></div>
        </div>
      </div>
    </div>
      ...
      <div id="top3" class="row" ng-if="page.skills.0.name !== ''" ng-repeat="skill in page.skills | orderBy: '-current' | limitTo: 3">
        <h3 class="skill_name col-xs-2">{{skill.name}}</h3>
          <div class="progress col-xs-10" id="base_bar">
            <div id="pbcurrent" class="progress-bar" style="width: {{skill.current * 10}}%" popover="Current Skill Level: {{skill.current}}" popover-trigger="mouseenter"></div>
            <div id="pbdesired" class="progress-bar" style="width: {{(skill.desired - skill.current) * 10}}%" popover="Desired Skill Level: {{skill.desired}}" popover-trigger="mouseenter"></div>
          </div>
      </div>
    </div>
            ...
            <div class="low_skills" ng-repeat="skill in page.skills | orderBy:'current' | limitTo: (page.skills.length -3) | orderBy:'-current'">
              ...
              <h3 class="skill_name col-xs-2">{{skill.name}}</h3>
                <div class="progress col-xs-10">
                  <div id="pbcurrent" class="progress-bar progress-bar-success" style="width: {{skill.current * 10}}%" popover="Current Skill Level: {{skill.current}}" popover-trigger="mouseenter"></div>
                  <div id="pbdesired" class="progress-bar progress-bar-warning" style="width: {{(skill.desired - skill.current) * 10}}%" popover="Desired Skill Level: {{skill.desired}}" popover-trigger="mouseenter"></div>
              </div>
            </div>
        </accordion-group>
      </accordion>
